                ...
                <div>
                       <div id="house">
                                <div id="writeup">
                                    ...
                                    <FacebookShareButton
                                              url={`https://us-central1-grelots-ad690.cloudfunctions.net/WebflyClick/dynamicpostRender?i=${props.musicThumb}&a=${props.musicArtist.toUpperCase()}&t=${props.musicTitle}&s=${props.section}`}
